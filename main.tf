resource "aws_instance" "public" {
  ...
  key_name                    = "daisy_keypair" #Change to your keyname, e.g. jazeel-key-pair
  vpc_security_group_ids = [aws_security_group.allow_ssh.id]
 
  tags = {
    Name = "daisy-terraform-ec2-18jan25"    #Prefix your own name, e.g. jazeel-ec2
  }
}

resource "aws_security_group" "allow_ssh" {
  name        = "daisy-terraform-security-group-ssh " #Security group name, e.g. jazeel-terraform-security-group
